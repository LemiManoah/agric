...
class Profile extends Component
{
    ...
    public function save()
    {
        ...
        $this->buyer = $this->buyerService->updateBuyer($this->buyer, $validated, auth()->user());

        session()->flash('status', 'Buyer profile updated successfully.');
    }

    public function render(): View
    {
        return view('livewire.buyer-portal.profile', [
