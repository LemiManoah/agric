...
class AgentService
{
    ...
    private function normalizePayload(array $data): array
    {
        return [
            ...
            'onboarding_status' => $data['onboarding_status'] instanceof AgentOnboardingStatus
                ? $data['onboarding_status']
                : AgentOnboardingStatus::from($data['onboarding_status'] ?? AgentOnboardingStatus::Onboarding->value),
